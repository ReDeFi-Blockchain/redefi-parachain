...
contract PrivateBalancesExtensions is Dummy, ERC165, ERC20 {
	...
	function showBalance(uint256 amount) public view {
		require(false, stub_error);
		amount;
		dummy;
	}
	...
	function hideBalance(uint256 amount) public view {
		require(false, stub_error);
		amount;
		dummy;
	}
	...
	function encryptedTransfer(bytes memory encryptedTx, bytes memory ephemeralKey, bytes memory nonce) public view {
		require(false, stub_error);
		encryptedTx;
		ephemeralKey;
		nonce;
...
contract NativeFungible is Dummy, ERC165, ERC20, ERC20Burnable, ERC20Mintable, XcmExtensions, PermissionsExtensions, PrivateBalancesExtensions {
}
