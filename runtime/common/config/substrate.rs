...
use sp_arithmetic::{traits::One, PerThing};
use sp_runtime::{
...
impl WeightToFeePolynomial for WeightToFee {
	...
	fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
		smallvec!(WeightToFeeCoefficient {
			coeff_integer: (up_common::constants::WEIGHT_TO_FEE_COEFF / Perbill::ACCURACY as u64)
				.into(),
			coeff_frac: Perbill::from_parts(
				(up_common::constants::WEIGHT_TO_FEE_COEFF & Perbill::ACCURACY as u64) as u32
			),
			negative: false,
			degree: 1,
		})
